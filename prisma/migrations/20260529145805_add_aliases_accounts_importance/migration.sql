-- AlterTable
ALTER TABLE "Keyword" ADD COLUMN "accounts" TEXT;
ALTER TABLE "Keyword" ADD COLUMN "aliases" TEXT;
...
INSERT INTO "new_Topic" ("author", "comments", "createdAt", "hotScore", "id", "isSpam", "keywordId", "likes", "publishedAt", "realScore", "reason", "relevScore", "reposts", "source", "sourceIcon", "summary", "title", "url", "views") SELECT "author", "comments", "createdAt", "hotScore", "id", "isSpam", "keywordId", "likes", "publishedAt", "realScore", "reason", "relevScore", "reposts", "source", "sourceIcon", "summary", "title", "url", "views" FROM "Topic";
DROP TABLE "Topic";
